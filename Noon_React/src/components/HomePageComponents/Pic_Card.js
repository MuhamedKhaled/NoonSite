...
class Pic_Card extends React.Component{

    render(){
       return(
        <div class="col-md-3 col-sm-6 ">
        <div class="card card-background magazine-card">
          <img class="image-adjustment magazine-pic-height" src="../../img/Global/maria2.jpg" alt="Card image cap"/>
          <div class="card-body">
            <h5 class="card-title profile-name">Maria Sharapova</h5>
            <p class="card-text profile-text  pic-magazine"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text </p>
